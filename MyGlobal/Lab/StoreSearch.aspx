<%@ Page Title="MyAdvantech - Search Advantech Online Store" Language="VB" MasterPageFile="~/Includes/MyMaster.master"
...
<script runat="server">
    ...
    Public Shared Function SuggestKeys(ByVal prefixText As String, ByVal count As Integer) As String()
        ...
        Else
            ...
            Dim DmKeys() As String = DataMiningUtil.SuggestKeysByDM(prefixText)
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs)
        ...
        'Response.Write("keys:" + String.Join(",", SuggestKeysByDM("adam")))
    ...
    Protected Sub btnSearch_Click(sender As Object, e As System.EventArgs)
        ...
        With sb
            ...
            .AppendLine(" 	where (a.APPNAME = 'eStore US') ")
            .AppendLine(" ) a ")
        ...
        'If dtResult.Rows.Count < 10 Then
        '    'apt.SelectCommand.Parameters.Clear()
        '    Dim dtResult2 As New DataTable
        '    apt.SelectCommand.CommandText = _
        '        " select top " + (MaxRows + 10).ToString() + " a.Title, a.Meta_Description, a.KEYID as k, cast(0.0 as float) as r,  " + _
        '        " IsNull(dbo.HighLightSearch(a.Text, @RAWTXT,'',150),left(a.Text,150)) as TxtHLight, a.ResponseUri, a.Depth, a.APPNAME  " + _
        '        " from MY_WEB_SEARCH a  " + _
        '        " where (a.[Text] like N'%'+@RAWTXT+'%' or a.Title like N'%'+@RAWTXT+'%') and a.APPNAME = 'eStore US' " + _
        '        " order by a.Depth  "
        '    apt.Fill(dtResult2)
                        ...
                        <asp:TemplateField ItemStyle-BorderStyle="None">
                            <ItemTemplate>
                                <div style="width: 100%">
                                    ...
                                    <div>
                                        <a style="color: #006621;" href='<%#Eval("ResponseUri") %>'>
