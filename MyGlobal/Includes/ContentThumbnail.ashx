<%@ WebHandler Language="VB" Class="ContentThumbnail" %>
...
Public Class ContentThumbnail : Implements IHttpHandler
    
    Public ImageWitdh As Int16 = 400
    Public ImageHeight As Int16 = 400
