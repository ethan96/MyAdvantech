...
<script runat="server">
    ...
    Protected Sub gv1_RowDataBound(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewRowEventArgs)
        If e.Row.RowType = DataControlRowType.DataRow Then
            ...
            e.Row.Cells(11).Text = Get_ABCIndicator(DBITEM.Item("PART_NO"))
            e.Row.Cells(12).Text = Is_XYPart(DBITEM.Item("PART_NO"))
            If (Not String.IsNullOrEmpty(Get_ABCIndicator(DBITEM.Item("PART_NO"))) Or Not String.IsNullOrEmpty(Is_XYPart(DBITEM.Item("PART_NO")))) Then
                For i As Integer = 0 To 12
                    e.Row.Cells(i).BackColor = Drawing.Color.FromName("#FFFF77")
                Next
            End If
    ...
    Public Function Get_ABCIndicator(ByVal PN As String) As String
        Dim dal As New Advantech.Myadvantech.DataAccess.MyAdvantechDAL
        Dim spa As List(Of Advantech.Myadvantech.DataAccess.SAP_PRODUCT_ABC) = dal.GetSAPProductABC_CDTPPart()
        Dim search_result As String = String.Empty
        search_result = (From s In spa Where s.PART_NO = PN Select s.ABC_INDICATOR).FirstOrDefault()
        Return search_result
    End Function
    
    Public Function Is_XYPart(ByVal PN As String) As String
        Dim dal As New Advantech.Myadvantech.DataAccess.MyAdvantechDAL
        Dim sp As List(Of Advantech.Myadvantech.DataAccess.SAP_PRODUCT) = dal.GetSAPProduct_XYPart()
        Dim search_result As String = String.Empty
        If ((From s In sp Where s.PART_NO = PN Select s).Any()) Then
            search_result = "Yes"
        End If
        Return search_result
    End Function
...
<body>
    ...
    <div id="divHeader">
        ...
        <asp:Label ID="lbNo" runat="server" Text="FU123456"></asp:Label>
    </div>
        ...
        <div id="divDetailInfo" class="mytable">
            ...
            <table width="100%">
                ...
                <tr>
                    <td align="right" runat="server" id="trFreight" visible="false">Freight：<%= CurrencySign%><asp:Label runat="server" ID="lbFt"></asp:Label></td>
                </tr>
                <tr>
                    <td align="right" runat="server" id="trTax" visible="false">Tax Rate：<asp:Label runat="server" ID="lbtax"></asp:Label></td>
                </tr>
                <tr>
                    <td align="right">Total：<%= CurrencySign%><asp:Label runat="server" ID="lbTotal"></asp:Label></td>
                </tr>
            </table>
        </div>
        <div id="divFooter">
