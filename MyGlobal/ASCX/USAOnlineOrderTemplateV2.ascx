...
<script runat="server">
    ...
    Protected Sub initGV(ByRef QuoteDetailTb As MyOrderDS.ORDER_DETAILDataTable)
        ...
        If DT IsNot Nothing AndAlso DT.Rows.Count > 0 Then
            ...
            'Dim _EQWS As New quote.quote-Exit
            ...
            'End If
            Dim MyQuoteMaster As QuotationMaster = eQuotationUtil.GetQuoteMasterByQuoteid(Me._QuoteID)
            If MyQuoteMaster IsNot Nothing Then
                If Not _IsFoucePrintFormat Then Me._pri_format = MyQuoteMaster.PRINTOUT_FORMAT
            End If
