    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs)
        If Not IsNothing(Request("NO")) AndAlso Request("NO") <> "" Then
            ...
            If _obj IsNot Nothing AndAlso Not String.IsNullOrEmpty(_obj) Then
                CurrencySign = Util.GetCurrencySignByCurrency(_obj)
            End If
...
<body>
    ...
    <div id="divHeader">
        <table>
            <tr>
                <td>
                    <img src="http://my.advantech.com/images/header_advantech_logo.gif" alt="Advantech"/>
                </td>
            </tr>
        </table>
    </div>
...
<%--        <table width="100%">
    ...
    <div id="divDetailInfo" class="mytable">
        ...
        <table width="100%">
            ...
            <tr><td align="right" runat="server" id="trFreight" visible="false"> Freight：<%= CurrencySign%><asp:Label runat="server" ID="lbFt"></asp:Label></td></tr>
            <tr><td align="right" runat="server" id="trTax" visible="false"> Tax Rate：<asp:Label runat="server" ID="lbtax"></asp:Label></td></tr>
            <tr><td align="right"> Total：<%= CurrencySign%><asp:Label runat="server" ID="lbTotal"></asp:Label></td></tr>
        </table>
    </div>
    <div id="divFooter">
        <br />
