<%@ Page Title="MyAdvantech - MyAdvantech Usage Report" Language="VB" MasterPageFile="~/Includes/MyMaster.master" %>
...
<script runat="server">
    ...
    Sub DrawChart()
        ...
        Select Case dlDateView.SelectedIndex
            Case 0
              ...
              " select dbo.DateOnly(LOGIN_TIME) as ST, COUNT(SESSIONID) as c from V_DIM_USER_LOG where LOGIN_TIME between " + _
        ...
        With c
            ...
            .addTitle(FromDate.Year.ToString() + " " + months(FromDate.Month - 1) + " MyAdvantech Usage ", "Arial Bold Italic", 11, &H333333).setBackground(&HECECEC, &HC7D5F1) : .yAxis().setTitle("Visits")
    ...
    Protected Sub btnXls_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs)
        ...
        Util.DataTable2ExcelDownload(dt, "AEUIT_MALog.xls")
    End Sub
</script>
                ...
                <asp:UpdatePanel runat="server" ID="up1" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <asp:SqlDataSource runat="server" ID="src1" ConnectionString="<%$ConnectionStrings:MY %>" 
                            SelectCommand="SELECT top 10000 USERID, LOGIN_TIME, LOGOUT_TIME, STAY_MINUTES FROM V_DIM_USER_LOG order by LOGIN_TIME desc" />
                    </ContentTemplate>
                    <Triggers>
