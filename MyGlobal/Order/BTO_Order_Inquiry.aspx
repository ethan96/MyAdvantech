<%@ Page Title="MyAdvantech - BTOS Quote/Order History Inquiry" Language="VB" MasterPageFile="~/Includes/MyMaster.master" %>
...
<script runat="server">
    ...
    Public Shared Function SearchBTOOrderList(ByVal QueryOrderCriteria1 As QueryOrderCriteria) As String
        ...
        With sbSql
            ...
            .AppendLine("     and a.KUNNR='" + HttpContext.Current.Session("company_id").ToString().ToUpper() + "' and a.AUART in ('ZOR','ZOR2','AG') and upper(a.BSTNK) like '%BTO%' and b.MATNR like '%BTO' ")
    ...
    Public Shared Function GetSODetail(ByVal QueryOrderCriteria1 As QueryOrderCriteria) As String
        ...
        With sbSql
            ...
            .AppendLine(" and a.KUNNR='" + HttpContext.Current.Session("company_id").ToString().ToUpper() +
                        "' and a.AUART in ('ZOR','ZOR2','AG') and a.VBELN='" + Global_Inc.SONoBuildSAPFormat(QueryOrderCriteria1.SONO) + "' ")
        ...
        For Each r As DataRow In dtSODetail.Rows
            ...
            If rPrice.Length > 0 Then
                r.Item("SUBTOTAL") = rPrice(0).Item("Netwr")
                r.Item("UNIT_PRICE") = rPrice(0).Item("Netwr")
                '20170420 TC: fix the divide by zero bug, never knew that this column could be zero...
                If rPrice(0).Item("Mglme") <> 0 Then r.Item("UNIT_PRICE") = rPrice(0).Item("Netwr") / rPrice(0).Item("Mglme")
            End If
...
<asp:Content ID="Content1" ContentPlaceHolderID="_main" runat="Server">
    ...
    <table>
        <tr style="height:50px" valign="center">
            <th><h2 style="color:Navy">BTOS Quote/Order History Inquiry</h2></th>
        </tr>
        <tr>
            <td align="center">
