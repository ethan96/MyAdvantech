<%@ Page Title="" Language="C#" MasterPageFile="~/Includes/MyMaster.master" AutoEventWireup="true" CodeFile="Product_Compatibility_TW.aspx.cs" Inherits="Lab_CBOMV2_Product_Compatibility_TW" %>
        ...
        $(function () {
            ...
            $("#btnSave").click(function () {
                ...
                if (pn1 == "" || pn2 == "") {
                    ...
                    $.ajax(
                        {
                            url: '<%=System.IO.Path.GetFileName(Request.ApplicationPath) %>/Services/CBOMV2_Editor.asmx/CreateProductCompatibilityTW', type: "POST",
            ...
            $.getJSON('<%=System.IO.Path.GetFileName(Request.ApplicationPath) %>/Services/CBOMV2_Editor.asmx/InitialProductCompatibilityTW', null, function (data) {
        ...
        function DeleteData(id) {
            if (!!id && id > 0) {
                if (confirm("Are you sure to delete it?") == true) {
                    $.getJSON('<%=System.IO.Path.GetFileName(Request.ApplicationPath) %>/Services/CBOMV2_Editor.asmx/DeleteProductCompatibilityTW', { ID: id }, function (data) {
                        if (data.Result == true) {
