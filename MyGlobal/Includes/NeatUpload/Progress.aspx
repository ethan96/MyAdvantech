...
-->
	...
	<body>
		...
		<tr>
		    <td colspan="2">
		        <span id="label" runat="server" class="Label" style="font-size:12px">Upload&#160;Status:</span>
		    </td>
		</tr>
		<tr>
		<td id="barTd" >
			<div id="statusDiv" runat="server" class="StatusMessage">&#160;
				<Upload:DetailsSpan id="normalInProgress" runat="server" WhenStatus="NormalInProgress" style="font-weight: normal; white-space: nowrap; font-size:12px">
				...
				<Upload:DetailsSpan id="chunkedInProgress" runat="server" WhenStatus="ChunkedInProgress" style="font-weight: normal; white-space: nowrap; font-size:12px">
