<%@ Page Title="CBOM Editor" Language="VB" EnableEventValidation="false" MasterPageFile="~/Includes/MyMaster.master"
    AutoEventWireup="false" CodeFile="CBOM_Editor_eq.aspx.vb" Inherits="WebCBOMEditor_Default" %>

<asp:Content ID="Content1" ContentPlaceHolderID="_main" runat="Server">
    <script type="text/javascript" src="../Includes/EasyUI/json2.js"></script>
    ...
    <div id="divP" style="overflow: scroll; overflow-x: hidden;">
        <ul id="tt" class="easyui-tree" data-options="
			...
			onContextMenu: function(e,node){
				...
				if (node.type.toUpperCase()=='ROOT'){$('#m3').hide();$('#m2').hide();$('#m4').hide();;$('#m1').show();}
                else if (node.type.toUpperCase()=='DM'){$('#m3').hide();$('#m2').hide();$('#m4').hide();;$('#m1').hide();}
                else
                {$('#m3').show();$('#m2').show();$('#m4').show();;$('#m1').show();}
                $('#mm').menu('show',{
					left: e.pageX,
					top: e.pageY
				});
            ...
            if (node.type.toUpperCase()=='CATEGORY') {$('#<%=Me.txtCategoryCopy.ClientID %>').val(node.id);};
            }
        ...
        <div id="dlg2" class="easyui-dialog" data-options="modal:false" title="Category"
            style="padding: 5px; width: 650px; height: 280px" closed="true">
            <asp:Panel ID="pa1" runat="server" DefaultButton="btnConfirm">
                <table>
                    <tr id="trCopy">
                        ...
                        <td>
                            <asp:TextBox runat="server" ID="txtCategoryCopy" Width="400px"></asp:TextBox>
                        </td>
                        <td>
        ...
        <div id="dlg3" class="easyui-dialog" data-options="modal:false" title="Component"
            style="padding: 5px; width: 650px; height: 300px" closed="true">
            <asp:Panel ID="pa2" runat="server" DefaultButton="Button2">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="radio" name="rbtnExpand" value="1" checked="checked" />
                            Expand
                            <input type="radio" name="rbtnExpand" value="0" />
                            Not Expand
                        </td>
                        <td>
                        </td>
        ...
        <div id="dlg" class="easyui-dialog" title="Pick Product" data-options="modal:false"
    ...
    <script type="text/javascript">
        ...
        function setPick(pn, desc) {
            if ($('#htype').val() == "CATEGORY") {
                ...
                $("#<%=Me.txtDescComp.ClientID %>").val(desc);
            }
            $('#dlg').dialog("close");
        }
        function sh() {
        ...
        function Append() {
            ...
            var node = t.tree('getSelected');
            var tt
            if (node.type.toUpperCase() == "CATEGORY" || ('<%=Request("UID") %>' != '' && node.type.toUpperCase() == "ROOT")) {
