...
<asp:Content ID="Content1" ContentPlaceHolderID="_main" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            if ("<%=Request("BTOItem")%>".indexOf("C-CTOS") != -1) {
                GetEOLItems();
            }
        });
        ...
        function GetEOLItems() {
            var postData = {
                ...
                ORGID: "<%=Session("ORG_ID").ToString%>"
            };
            $.ajax({
                url: "<%= Util.GetRuntimeSiteUrl()%>/Services/MyServices.asmx/CheckConfiguratorEOLItems",
                type: "POST",
                dataType: 'json',
                data: postData,
        ...
        function appendChildCBom(tableElement, CategoryValue, level) {
            ...
            busyMode(1);
            var postData = JSON.stringify({ ParentCategoryId: CategoryValue, ConfigQty: $('#hdConfigQty').val(), RootId: $('#hdBTOId').val() });
            $.ajax(
                {
        ...
        function appendChildCBomSuccess(retData, tableElement, level) {
            ...
            $.each(bomRows, function (index, item) {
                ...
                TraversalSeq += 1;
                var childTableId = "chtb_" + item.ClientId + "_" + (level + 1) + "_" + TraversalSeq; selGrpName = "grp_" + childTableId + "_" + TraversalSeq;
                ...
                var showHideAnchorId = "showHideAnchor_" + item.ClientId + "_" + TraversalSeq; trSelId = "trSel_" + item.ClientId + "_" + TraversalSeq;
                ...
                $.each(item.ChildCategories, function (idx, compItem) {
                    ...
                    var inputCompId = "rcomp_" + compItem.ClientId + "_" + idx + "_" + (level + 1) + "_" + TraversalSeq;
                    compSelection +=
                                "<tr>" +
                                    "<td>" +
