        ...
        <ContentTemplate>
            <table width="100%">
                ...
                <tr>
                    ...
                    <td align="center" style="FONT-SIZE: 14px; COLOR: #008736; LINE-HEIGHT: 20px; FONT-FAMILY: Arial, Helvetica, sans-serif; TEXT-DECORATION: none"><b>此信息对您是否有用？</b></td>
                </tr>
                <tr>
                    <td align="center">
                        <table>
                            <tr>
                                <td style="FONT-SIZE: 12px; FONT-FAMILY: Arial, Helvetica, sans-serif">
                                    <asp:RadioButtonList runat="server" ID="rbl1" RepeatDirection="Horizontal" Width="220px">
                                        ...
                                        <asp:ListItem Text="有用" Value="0" />
                                        <asp:ListItem Text="没用" Value="1" />
                                        <asp:ListItem Text="不知道" Value="2" />
                                    </asp:RadioButtonList>
                                </td>
                                <td width="20"></td>
                                <td>
